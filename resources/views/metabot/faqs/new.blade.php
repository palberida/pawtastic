        ...
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('metabot.faqs.store') }}">
                        @csrf

                        <div>
                            <label for="topic" class="block text-sm font-medium text-gray-700">Tema</label>
                            <input list="faq_topics" type="text" name="topic" id="topic" maxlength="64" value="{{ old('topic') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="trigger_description" id="trigger_description" rows="2" maxlength="500" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('trigger_description') }}</textarea>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="answer_text" id="answer_text" rows="4" maxlength="1024" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('answer_text') }}</textarea>
                        </div>
